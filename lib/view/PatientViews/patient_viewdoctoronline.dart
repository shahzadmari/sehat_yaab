...
import 'package:sehat_yaab/controller/PatientAppointmentController/patientonlineview_controller.dart';

class PatientOnlineView extends StatelessWidget {
  final doctor;
  const PatientOnlineView({super.key, this.doctor});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(PatientOnlineViewController());

    List getOnlineAppointments() {
      return doctor.availibilitySchedule
          .where((schedule) => schedule.appointmentType == 'online')
          .toList();
    }
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children:
                      List.generate(getOnlineAppointments().length, (index) {
                    final availableDays = getOnlineAppointments();
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount:
                      getOnlineAppointments()[controller.selectedDay.value]
                          .timeSlots
                          .length,
